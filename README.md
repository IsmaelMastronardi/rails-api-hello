...
# 📖 React Rails Api <a name="about-project"></a>

** React Rails Api ** is a Ruby on Rails aplication that returns greetings.
...
Feel free to check the [issues page](https://github.com/IsmaelMastronardi/react-rails-hello-world/issues).
